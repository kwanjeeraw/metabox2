                                                                   ...
                                                                   sidebarLayout(
                                                                     column(3,
                                                                            sidebarPanel(width=12,style = "overflow-y:scroll; max-height: 900px; position:relative; height: 600px;",
                                                                                         ...
                                                                                         h6("*serrf method take long execution time."),
                                                                                              ...
                                                                                              tabsetPanel(id = "UNItabset",
                                                                                                          tabPanel("Overview", value = "UNIoverview",br(),
                                                                                                                   column(12,
                                                                                                                          ...
                                                                                                                          h5("*Display only the top 100 variables, sorted by adjusted p-values. Click on a dot to toggle its boxplot."),
                                                                                                                          hr(style="border-top: 1px dashed #D3D3D3;"),
                                             ...
                                             sidebarLayout(
                                               column(width=3,
                                                      sidebarPanel(width=12,style = "overflow-y:scroll; max-height: 900px; position:relative; height: 750px;",
                                                                   ...
                                                                   h6("*It might take long execution time depended on dataset size and the number of repetitions."),
                                    ...
                                    tabsetPanel(id = "MBPLTabset",
                                                ...
                                                tabPanel("Upload data", value = "mbplUP",
                                                         fluidRow(width=12,
                                                                  sidebarLayout(
                                                                    column(3,
                                                                           ##text input dataset name
                                                                           sidebarPanel(width=12,style = "overflow-y:scroll; max-height: 900px; position:relative; height: 750px;",
                                                                                        h4("Start upload your data"),
                                                                                        br(),
                                                                                        selectInput("MBPLdmun","Number of datasets",choices=c(2,3,4,5), selected=2,multiple = F, width = 300),
                                                                                        h6("*The data must be in a CSV file, limit to 5 datasets."),
                                                                                        actionButton("NextMBPL1", "Data set 1",style="color: #464546; background-color: #c5d7d9;"),
                                                                                        fileInput("INfileMBPL1",h5("Upload a csv file of dataset 1")),
                                                                                        textInput("nameMBPL1",label=h5("Dataset name")),
                                                                                        ...
                                                                                        fileInput("INfileMBPL2",h5("Upload a csv file of dataset 2")),
                                                                                        textInput("nameMBPL2",label=h5("Dataset name")),
                                                                                        ...
                                                                                        fileInput("INfileMBPL3",h5("PUpload a csv file of dataset 3")),
                                                                                        textInput("nameMBPL3",label=h5("Dataset name")),
                                                                                        ...
                                                                                        fileInput("INfileMBPL4",h5("Upload a csv file of dataset 4")),
                                                                                        textInput("nameMBPL4",label=h5("Dataset name")),
                                                                                        ...
                                                                                        fileInput("INfileMBPL5",h5("Upload a csv file of dataset 5")),
                                                                                        textInput("nameMBPL5",label=h5("Dataset name")),
                                                                  ...
                                                                  sidebarLayout(
                                                                    column(width=3,
                                                                           sidebarPanel(width=12,style = "overflow-y:scroll; max-height: 900px; position:relative; height: 750px;",
                                                                                        ...
                                                                                        h6("*It might take long execution time depended on dataset size, the number of repetitions and model testing process."),br(),
